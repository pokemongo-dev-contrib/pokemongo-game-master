call mvn clean
rem call mvn package exec:java -Dexec.mainClass="com.pokebattler.gamemaster.GenerateJSON" -Dexec.args="v2_GAME_MASTER.protobuf GAME_MASTER.json --oldmode"
...
rem mv GAME_MASTER.json versions/latest/.
